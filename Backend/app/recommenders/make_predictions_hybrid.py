...
def combine_predictions(predCF, predCB, user_input, user_output):    
    ...
    directors = [
        'Alfred Hitchcock', 'Andrew Davis', 'Andrew Stanton', 'Barry Levinson',
        'Barry Sonnenfeld', 'Brian De Palma', 'Bryan Singer', 'Chris Columbus',
        'Christopher Nolan', 'David Fincher', 'Francis Ford Coppola',
        'Frank Darabont', 'George Lucas', 'James Cameron', 'Jan de Bont',
        'Joel Coen', 'Joel Schumacher', 'John McTiernan', 'Jonathan Demme',
        'Lilly Wachowski', 'Martin Scorsese', 'Mel Gibson', 'Michael Bay',
        'Peter Jackson', 'Quentin Tarantino', 'Richard Donner', 'Ridley Scott',
        'Rob Reiner', 'Robert Zemeckis', 'Roland Emmerich', 'Ron Howard',
        'Sam Mendes', 'Stanley Kubrick', 'Steven Spielberg', 'Terry Gilliam',
        'Tim Burton', 'Tom Shadyac', 'Tony Scott', 'Wolfgang Petersen'
    ]

    directors2 = [
        'Steven Spielberg', 'Robert Zemeckis', 'Christopher Nolan',
        'James Cameron', 'Quentin Tarantino', 'Peter Jackson', 'David Fincher',
        'Ridley Scott', 'Martin Scorsese', 'Tim Burton', 'Ron Howard',
        'Frank Darabont', 'Francis Ford Coppola', 'George Lucas',
        'Stanley Kubrick', 'John McTiernan', 'Roland Emmerich', 'Chris Columbus',
        'Jonathan Demme', 'Rob Reiner', 'Bryan Singer', 'Terry Gilliam',
        'Joel Coen', 'Lilly Wachowski', 'Barry Sonnenfeld', 'Alfred Hitchcock',
        'Joel Schumacher', 'Tom Shadyac', 'Wolfgang Petersen', 'Jan de Bont',
        'Tony Scott', 'Richard Donner', 'Michael Bay', 'Mel Gibson',
        'Brian De Palma', 'Andrew Stanton', 'Sam Mendes', 'Andrew Davis',
        'Barry Levinson'
    ]
